    ...
    <div className="contenedor">
      ...
      <div className="contactame">
        ...
        <nav className="nav-contactame">
          <a href="https://wa.me/+584126754878" target="_blank" rel="noreferrer"><i style={{ cursor: 'pointer' }} class="fab fa-whatsapp"></i></a>
          <a href="https://www.linkedin.com/in/jisrael/" target="_blank" rel="noreferrer"><i style={{ cursor: 'pointer' }} class="fab fa-linkedin-in"></i></a>
          <a href="mailto:jisraelarguelles@gmail.com" target="_blank" rel="noreferrer"><i style={{ cursor: 'pointer' }} class="far fa-envelope"></i></a>
        </nav>
      </div>
    </div>
